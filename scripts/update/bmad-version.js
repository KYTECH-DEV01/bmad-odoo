...
async function main() {
  ...
  console.log('');
  console.log(chalk.bold('BMAD Odoo Version Information'));
  console.log('');

  // Not in a BMAD Odoo project
  if (!projectRoot) {
    console.log(chalk.yellow('Status:           Not in a BMAD Odoo project'));
  ...
  if (scenario === 'partial' || !currentVersion) {
    ...
    console.log('');
    console.log('Try running: ' + chalk.cyan('npx -p bmad-odoo bmad-install'));
    console.log('');
  ...
  if (scenario === 'corrupted') {
    ...
    console.log('');
    console.log('Run: ' + chalk.cyan('npx -p bmad-odoo bmad-install') + ' to reinstall');
    console.log('');
    return;
  }
  ...
  if (currentVersion === targetVersion) {
    ...
    console.log('');
    console.log('Run: ' + chalk.cyan('npx -p bmad-odoo@latest bmad-update --dry-run') + ' (to preview)');
    console.log('     ' + chalk.cyan('npx -p bmad-odoo@latest bmad-update') + ' (to apply)');
  } else {
