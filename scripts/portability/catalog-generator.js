...
const TIER_BADGES = {
  ...
  pipeline: '**🔒 Framework only** (Requires full BMAD Odoo installation)',
};
...
function generateCatalog(projectRoot) {
  ...
  // Header
  lines.push('# BMAD Odoo Skills Catalog');
  lines.push('');
  ...
  lines.push('- **🔒 Framework only** — requires full BMAD Odoo installation');
  lines.push('');
  lines.push(
  ...
  if (pipelineSkills.length > 0) {
    ...
    lines.push('');
    lines.push('<details>');
    lines.push('<summary><strong>Framework-only skills (requires BMAD Odoo installation)</strong></summary>');
    lines.push('');
  ...
  lines.push('---');
  lines.push('');
  lines.push(`*Generated by \`bmad-export\` — do not edit manually.*`);
  lines.push(`*Generated on ${new Date().toISOString().slice(0, 10)}.*`);
  lines.push('');
  lines.push('For the full BMAD Odoo framework, see the [BMAD Odoo repository](https://github.com/KYTECH-DEV01/bmad-odoo).');
  lines.push('');
