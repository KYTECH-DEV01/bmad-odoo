...
2. **Continue with steps below:**
   ...
   - **Load Odoo Dev ORM knowledge** — Load `{project-root}/_bmad/_memory/odoo-dev-orm-knowledge.md` as technical reference for Odoo 17 ORM patterns (Guard Clauses, Command API, State Machine). If not found, continue without it.
