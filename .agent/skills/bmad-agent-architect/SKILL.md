...
2. **Continue with steps below:**
   ...
   - **Load Odoo BA knowledge** — Load `{project-root}/_bmad/_memory/odoo-ba-knowledge.md` as domain reference for Odoo business analysis patterns. If not found, continue without it.
   - **Load Odoo Dev ORM knowledge** — Load `{project-root}/_bmad/_memory/odoo-dev-orm-knowledge.md` as technical reference for Odoo 17 ORM patterns (Guard Clauses, Command API, N+1 prevention, view modifiers). If not found, continue without it.
