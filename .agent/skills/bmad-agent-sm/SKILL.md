...
2. **Continue with steps below:**
   ...
   - **Load Odoo BA knowledge** — Load `{project-root}/_bmad/_memory/odoo-ba-knowledge.md` as domain reference for Odoo business analysis patterns (state machines, user stories, edge cases). If not found, continue without it.
